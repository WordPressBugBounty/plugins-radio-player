...
<div class="wrap recommended-plugins">
    <h2 class="recommended-plugins-header">
		<?php _e( 'Try out our recommended plugins', 'radio-player' ); ?>
        <a class="hide-recommended-btn" href="#" class=""><?php _e( 'Hide From Menu', 'radio-player' ); ?></a>
    </h2>
</div>
<div class="wrap recommended-plugins">
    ...
    <div id="hide-recommeded-plugins" style="display:none;" title="<?php _e( 'Are you sure?', 'radio-player' ); ?>">
        <p><?php _e( "If you hide the recommended plugins page from your menu, it won't appear there again. Are you sure you'd like to do it?", 'radio-player' ); ?></p>
    </div>
            ...
            $('a.hide-recommended-btn').on('click', function (event) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        wp.ajax.send('radio_player_hide_recommended_plugins', {
                            success: function () {
                                Swal.fire({
                                ...
                                setTimeout(function () {
                                    window.location = radioPlayer.admin_url + 'admin.php?page=radio-player';
                                }, 2500);
